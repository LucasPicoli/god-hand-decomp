...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(l) macro (lines 288-300).
...
extern unsigned char D_003C4418[8];          /* __til */
extern const char D_004510E0[];              /* "l" */

extern "C" const type_info &func_0031FC08 (void)
  __attribute__((section(".text.func_0031FC08")));

extern "C" const type_info &func_0031FC08 (void) {
  if ((*(void **) D_003C4418) == 0)
    new (D_003C4418) __builtin_type_info (D_004510E0);
  return *(type_info *)D_003C4418;
}
