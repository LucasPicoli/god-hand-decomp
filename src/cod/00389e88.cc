...
extern "C" int Tramp__IO_sungetc_38B480(streambuf *);

__attribute__((section(".text.unget__7istream")))
istream& istream::unget() {
	if (good() && Tramp__IO_sungetc_38B480(_strbuf) == EOF) clear(ios::badbit);
	return *this;}
