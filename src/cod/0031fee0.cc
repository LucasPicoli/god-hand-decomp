...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(Uc) macro (lines 288-300).
...
extern unsigned char D_003C4480[8];          /* __tiUc */
extern const char D_00451148[];              /* "Uc" */

extern "C" const type_info &func_0031FEE0 (void)
  __attribute__((section(".text.func_0031FEE0")));

extern "C" const type_info &func_0031FEE0 (void) {
  if ((*(void **) D_003C4480) == 0)
    new (D_003C4480) __builtin_type_info (D_00451148);
  return *(type_info *)D_003C4480;
}
