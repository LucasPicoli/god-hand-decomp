...
extern int getline__7istreamPcic(void *a, char *b, int c, char d);
extern int __ls__7ostreamc();

__attribute__((section(".text.func_0038A1D8")))
int func_0038A1D8(void *a0, char *a1, int a2, int a3) {
    return getline__7istreamPcic(a0, a1, a2, (char)a3);
}
...
int func_0038A238(void *a0, char *a1, int a2, int a3) {
    return getline__7istreamPcic(a0, a1, a2, (char)a3);
}
...
int func_0038A588(void *a0, int a1) {
    return __ls__7ostreamc(a0, (char)a1);
}

__attribute__((section(".text.func_0038A5A8")))
int func_0038A5A8(void *a0, int a1) {
    return __ls__7ostreamc(a0, (char)a1);
}
