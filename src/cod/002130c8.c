...
__attribute__((section(".text.func_002130C8")))
void func_002130C8(void *a0)
{
    char *p = (char *)a0;
    int flag = 1;
    int s2v, s0v, gb;
        ...
        case 0x265:
            {
                ...
                if (*(float *)(p + 0x618) > 64.0f && (Forward30F348_31CFE0() & 1) != 0) {
                    ...
                    if (t2 != 0) {
                        ForwardAnimParamPairByIndex_27EA50(t2, 5);
                    }
                } else {
                    int b3 = *(int *)(p + 0x304);
                    int t3 = *(int *)(p + 0x744);
                    s0v = *(int *)(b3 + 0x3738) + b3;
                    if (t3 != 0) {
                        ForwardAnimParamPairByIndex_27EA50(t3, 4);
                    }
                }
            }
            break;
    ...
    if (*(short *)(Obj0000_Get_D_00747A94_2DB6B0() + 0x54A) <= 0
        ...
        if (*(int *)(p + 0x16EC) > 0) {
            if (*(float *)(p + 0x618) > 64.0f) {
                if ((unsigned int)(*(int *)(p + 0x564) - 0x250) < 2) {
                    *(char *)(p + 0x2F4) = 0;
                    *(char *)(p + 0x2F5) = 0xB;
                    *(char *)(p + 0x2F6) = 0;
                    *(char *)(p + 0x2F7) = 0;
