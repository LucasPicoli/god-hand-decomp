...
/* libio fileops.c :: _IO_file_underflow */
__attribute__((section(".text.func_00392BA0")))
int func_00392BA0(struct _IO_FILE *fp) {
    _IO_ssize_t count;
