...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(d) macro (lines 288-300).
...
extern unsigned char D_003C4450[8];          /* __tid */
extern const char D_00451118[];              /* "d" */

extern "C" const type_info &func_0031FD90 (void)
  __attribute__((section(".text.func_0031FD90")));

extern "C" const type_info &func_0031FD90 (void) {
  if ((*(void **) D_003C4450) == 0)
    new (D_003C4450) __builtin_type_info (D_00451118);
  return *(type_info *)D_003C4450;
}
