...
/* wave 31 L1_libstdcxx: every inline member of streambuf is DECLARED, not defined, so the TU
...
extern "C" void func_0038CC88(_IO_FILE *, int);   /* _IO_default_finish */

__attribute__((section(".text._$_9streambuf")))
streambuf::~streambuf()
{
  func_0038CC88(this, 0);
}
