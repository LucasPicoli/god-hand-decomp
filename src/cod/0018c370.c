...
extern struct Table_func_0018C370 D_004238B8;

struct Entry_func_0018C370 { short f0; unsigned short type; unsigned short f4; short f6; };
struct Table_func_0018C370 { struct Entry_func_0018C370 e[4]; };

__attribute__((section(".text.func_0018C370")))
void func_0018C370(void *a0)
{
    char *s0 = (char *)a0;
    struct Table_func_0018C370 buf;
    char *e;
    int i8;
    int f0;
