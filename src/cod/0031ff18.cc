...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(Sc) macro (lines 288-300).
...
extern unsigned char D_003C4488[8];          /* __tiSc */
extern const char D_00451150[];              /* "Sc" */

extern "C" const type_info &func_0031FF18 (void)
  __attribute__((section(".text.func_0031FF18")));

extern "C" const type_info &func_0031FF18 (void) {
  if ((*(void **) D_003C4488) == 0)
    new (D_003C4488) __builtin_type_info (D_00451150);
  return *(type_info *)D_003C4488;
}
