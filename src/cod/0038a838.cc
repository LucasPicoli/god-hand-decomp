...
/* wave 31 L9_clones: ostream::~ostream() declared in-class and defined below; every other inline
   member of ostream is DECLARED, not defined (L1 declare-not-define lever), so the TU emits no
   plain-.text global beside the carve. --- */
...
/* ---- body ---- */
__attribute__((section(".text._$_7ostream")))
ostream::~ostream() { }
