...
/* ---- body ---- */
/* <ctype.h>: newlib spells isspace as a lookup one past the base of the
   character-class table.  The table's live name is D_0045F039. */
extern unsigned char D_0045F039[];
#define _S 010
#define isspace(c) (D_0045F039[(c)] & _S)

__attribute__((section(".text.skip_ws__FP9streambuf")))
