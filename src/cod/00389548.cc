...
/* ---- body ---- */
/* newlib reentrancy block: D_003FA62C is _impure_ptr, fflush is fflush */
extern "C" {
struct __sFILE;
struct _reent { int _errno; struct __sFILE *_stdin; struct __sFILE *_stdout;
                struct __sFILE *_stderr; };
extern struct _reent *D_003FA62C;
int fflush(struct __sFILE *);
}
#define stdout (D_003FA62C->_stdout)
#define stderr (D_003FA62C->_stderr)
#define fflush fflush

/* libio iostream.cc :: ostream::do_osfx() */
__attribute__((section(".text.do_osfx__7ostream")))
