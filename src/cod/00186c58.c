...
extern struct Table_func_00186C58 D_00423058;

struct Entry_func_00186C58 { short f0; unsigned short type; unsigned short f4; short f6; };
struct Table_func_00186C58 { struct Entry_func_00186C58 e[4]; };

__attribute__((section(".text.func_00186C58")))
void func_00186C58(void *a0)
{
    char *s0 = (char *)a0;
    struct Table_func_00186C58 buf;
    char *e;
    int i8;
    int f0;
