...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(Us) macro (lines 288-300).
...
extern unsigned char D_003C4478[8];          /* __tiUs */
extern const char D_00451140[];              /* "Us" */

extern "C" const type_info &func_0031FEA8 (void)
  __attribute__((section(".text.func_0031FEA8")));

extern "C" const type_info &func_0031FEA8 (void) {
  if ((*(void **) D_003C4478) == 0)
    new (D_003C4478) __builtin_type_info (D_00451140);
  return *(type_info *)D_003C4478;
}
