...
extern struct Table_func_00174A78 D_004210B0;

struct Entry_func_00174A78 { short f0; unsigned short type; unsigned short f4; short f6; };
struct Table_func_00174A78 { struct Entry_func_00174A78 e[4]; };

__attribute__((section(".text.func_00174A78")))
void func_00174A78(void *a0)
{
    char *s0 = (char *)a0;
    struct Table_func_00174A78 buf;
    char *e;
    int i8;
    int f0;
