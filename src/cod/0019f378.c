...
extern struct Table_func_0019F378 D_004267D8;

struct Entry_func_0019F378 { short f0; unsigned short type; unsigned short f4; short f6; };
struct Table_func_0019F378 { struct Entry_func_0019F378 e[4]; };

__attribute__((section(".text.func_0019F378")))
void func_0019F378(void *a0)
{
    char *s0 = (char *)a0;
    struct Table_func_0019F378 buf;
    char *e;
    int i8;
    int f0;
