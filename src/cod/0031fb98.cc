...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(v) macro (lines 288-300).
...
extern unsigned char D_003C4408[8];          /* __tiv */
extern const char D_004510D0[];              /* "v" */

extern "C" const type_info &func_0031FB98 (void)
  __attribute__((section(".text.func_0031FB98")));

extern "C" const type_info &func_0031FB98 (void) {
  if ((*(void **) D_003C4408) == 0)
    new (D_003C4408) __builtin_type_info (D_004510D0);
  return *(type_info *)D_003C4408;
}
