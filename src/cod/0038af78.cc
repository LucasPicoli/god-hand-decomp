...
/* ---- body ---- */
extern "C" { int _IO_vfscanf __P ((_IO_FILE *, const char *, _IO_va_list, int *)); }
/* gcc-2.95.2 ginclude/va-mips.h, the __mips_eabi + __mips_single_float arm */
...
__attribute__((section(".text.scan__9streambufPCce")))
