...
__attribute__((section(".text.func_002363E8")))
void func_002363E8(void *a0)
{
    char *s0 = (char *)a0;
    ...
    case 0:
    {
        ...
        *(char *)(s0 + 0x1864) = 0;
        p = *(int *)(s0 + 0x304);
        func_002A8578(s0, *(int *)(p + 0x7E8) + p, *(int *)(p + 0x7EC) + p,
                      0.0f, 0, 0, 0);
        switch (cCoreSave_getGameLevel(&D_00569B70)) {
        case 1: default: *(short *)(s0 + 0x568) = 0x14; break;
        case 2: *(short *)(s0 + 0x568) = 0x1E; break;
        case 3: case 4: *(short *)(s0 + 0x568) = 0x28; break;
        case 5: *(short *)(s0 + 0x568) = 0x32; break;
        }
        *(short *)(s0 + 0x56A) = 4;
        *(short *)(s0 + 0x56E) = 0xF;
    ...
    case 2:
    {
        ...
        *(char *)(s0 + 0x1864) = 0;
        p = *(int *)(s0 + 0x304);
        func_002A8578(s0, *(int *)(p + 0x7D8) + p, *(int *)(p + 0x7DC) + p,
                      0.0f, 0, 0, 0);
        (*(unsigned char *)(s0 + 0x2F6))++;
    }
        /* fallthrough */
    ...
    case 6:
    {
        ...
        *(char *)(s0 + 0x1864) = 0;
        p = *(int *)(s0 + 0x304);
        func_002A8578(s0, *(int *)(p + 0x7E0) + p, *(int *)(p + 0x7E4) + p,
                      0.0f, 3, 0, 0);
        (*(unsigned char *)(s0 + 0x2F6))++;
    }
        /* fallthrough */
