...
extern struct Table_func_0018D160 D_004239A8;

struct Entry_func_0018D160 { short f0; unsigned short type; unsigned short f4; short f6; };
struct Table_func_0018D160 { struct Entry_func_0018D160 e[4]; };

__attribute__((section(".text.func_0018D160")))
void func_0018D160(void *a0)
{
    char *s0 = (char *)a0;
    struct Table_func_0018D160 buf;
    char *e;
    int i8;
    int f0;
