...
/* wave 31 L1_libstdcxx: every inline member of ostdiostream is DECLARED, not defined, so the TU
   emits no plain-.text global beside the carve (the class vtable lives here, which made g++ 2.x
   export all of them and the full-ELF link reported multiple definitions). --- */
...
/* ---- body ---- */
__attribute__((section(".text._$_12ostdiostream")))
