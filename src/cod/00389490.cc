...
/* libioP.h's _IO_sputn, written out: JUMP2(__xsputn, ...) is a call through the
   _IO_jump_t slot with NO C++ this-adjustment.  libioP.h itself pulls errno.h
   and iolibio.h, which this tree has no include path for. */
...
__attribute__((section(".text.write__7ostreamPCci")))
