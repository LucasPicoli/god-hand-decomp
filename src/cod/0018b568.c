...
extern struct Table_18B D_004237C8;

struct Entry_18B { short f0; unsigned short type; unsigned short f4; short f6; };
struct Table_18B { struct Entry_18B e[4]; };

__attribute__((section(".text.func_0018B568")))
void func_0018B568(void *a0)
{
    char *s0 = (char *)a0;
    struct Table_18B buf;
    char *e;
    int i8;
    int f0;
