...
/* ---- body ---- */
/* The free function ostream& flush(ostream&) is at 0x003892C0; this repo
   currently names that address Tramp_flush__7ostream_3892C0. */
extern "C" ostream& Tramp_flush__7ostream_3892C0(ostream& outs);
#define flush Tramp_flush__7ostream_3892C0

__attribute__((section(".text.endl__FR7ostream")))
