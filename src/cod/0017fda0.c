...
__attribute__((section(".text.func_00181920")))
int func_00181920(char *p)
{
    float f[16];
    float *m;
    float *nv;
...
__attribute__((section(".text.func_0017FDA0")))
void func_0017FDA0(char *p)
{
