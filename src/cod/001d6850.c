...
__attribute__((section(".text.func_001D6850")))
void func_001D6850(void *a0, int a1, int a2, int a3) {
    char *s0 = (char *)a0;
    switch (a1 & 0xFFFF) {
    default:
    case 0:
        CustomIDWork_SetOffsetPosX(s0 + 0xC00, -0x1C2);
        SetFlagOnEntries7C_1D51B8(s0, 0x18, 0);
        break;
    case 1:
        CustomIDWork_SetOffsetPosX(s0 + 0xC00, 0);
        SetFlagOnEntries7C_1D51B8(s0, 0x18, 1);
        break;
    case 2:
        CustomIDWork_SetMoveOffsetPosX(s0 + 0xC00, -0x1C2, 0, 0x14);
        SetFlagOnEntries7C_1D51B8(s0, 0x18, 1);
        break;
    case 3:
        CustomIDWork_SetMoveOffsetPosX(s0 + 0xC00, 0, 0x1C2, 0x14);
        SetFlagOnEntries7C_1D51B8(s0, 0x18, 1);
        break;
    case 4: {
        char *p = s0 + 0xC00;
