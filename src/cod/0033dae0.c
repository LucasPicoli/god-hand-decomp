...
__attribute__((section(".text.func_0033DAE0")))
Sint32 func_0033DAE0(ADXB adxb, Sint8 *ibuf, Sint32 ibuflen)
{
    Sint16 dlen;

    adxb->hdcdflag = 1;
    if (func_0033D9C0(ibuf, ibuflen, &dlen, &adxb->code, &adxb->bps, &adxb->blklen,
