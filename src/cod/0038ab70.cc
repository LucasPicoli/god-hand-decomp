...
/* ---- body ---- */
/* --- gcc-2.95.2 libio/isgetline.cc, _sb_readline, verbatim.  memcpy is retail's
   func_003A5148 (the landed C TUs declare it under that name). --- */
#define CHUNK_SIZE 512
/* libioP.h */
extern "C" _IO_size_t _IO_getline_info (_IO_FILE *, char *, _IO_size_t, int, int, int *);
extern "C" void *func_003A5148(void *d, const void *s, unsigned int n); /* memcpy */
#define memcpy func_003A5148

__attribute__((section(".text._sb_readline__FP9streambufRlc")))
