...
extern void __builtin_delete(void *obj);
extern void ClearAndResetFields_1FE278(void *a, void *b);
extern void SetField214PtrThenInit_1B6F38(void *obj, void *a1);

/* InitObjVtableField35C_139878: store vtable at obj+0x35C (always); call __builtin_delete
...
extern int _IO_seekpos(void *this);
__attribute__((section(".text.func_0038BBB8")))
int func_0038BBB8(void *this) { return _IO_seekpos(this); }

extern int _IO_seekoff(void *this);
__attribute__((section(".text.func_0038BBD8")))
int func_0038BBD8(void *this) { return _IO_seekoff(this); }
