...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(Ul) macro (lines 288-300).
...
extern unsigned char D_003C4468[8];          /* __tiUl */
extern const char D_00451130[];              /* "Ul" */

extern "C" const type_info &func_0031FE38 (void)
  __attribute__((section(".text.func_0031FE38")));

extern "C" const type_info &func_0031FE38 (void) {
  if ((*(void **) D_003C4468) == 0)
    new (D_003C4468) __builtin_type_info (D_00451130);
  return *(type_info *)D_003C4468;
}
