...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(w) macro (lines 288-300).
...
extern unsigned char D_003C4440[8];          /* __tiw */
extern const char D_00451108[];              /* "w" */

extern "C" const type_info &func_0031FD20 (void)
  __attribute__((section(".text.func_0031FD20")));

extern "C" const type_info &func_0031FD20 (void) {
  if ((*(void **) D_003C4440) == 0)
    new (D_003C4440) __builtin_type_info (D_00451108);
  return *(type_info *)D_003C4440;
}
