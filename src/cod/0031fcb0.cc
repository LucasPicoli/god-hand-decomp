...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(b) macro (lines 288-300).
...
extern unsigned char D_003C4430[8];          /* __tib */
extern const char D_004510F8[];              /* "b" */

extern "C" const type_info &func_0031FCB0 (void)
  __attribute__((section(".text.func_0031FCB0")));

extern "C" const type_info &func_0031FCB0 (void) {
  if ((*(void **) D_003C4430) == 0)
    new (D_003C4430) __builtin_type_info (D_004510F8);
  return *(type_info *)D_003C4430;
}
