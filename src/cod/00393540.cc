...
/* ---- body ---- */
/* fileno lives at 0x003A6130; this repo names that address func_003A6130. */
extern "C" int func_003A6130(FILE *);
#define fileno(f) func_003A6130(f)

__attribute__((section(".text.__8stdiobufP7__sFILE")))
