...
extern struct Table_0017ADE0 D_003BDBC0;

struct Entry_0017ADE0 { short f0; short f2; short f4; short f6; };
struct Table_0017ADE0 { struct Entry_0017ADE0 e[1]; };


__attribute__((section(".text.func_001A7880")))
void func_001A7880(void *a0)
{
    char *s0 = (char *)a0;
    char *e;
    int i8;
    ...
    if (type >= 0) {
        ...
        fp = *(int (**)(int))((char *)&D_003BDBC0 + i8 + 4);
    }
    f0 = D_003BDBC0.e[*(unsigned char *)(s0 + 0x2F4)].f0;
    if (type >= 0)
        arg = (short)entry + f0;
    else
        arg = f0;
