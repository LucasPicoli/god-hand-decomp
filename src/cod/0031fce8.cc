...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(c) macro (lines 288-300).
...
extern unsigned char D_003C4438[8];          /* __tic */
extern const char D_00451100[];              /* "c" */

extern "C" const type_info &func_0031FCE8 (void)
  __attribute__((section(".text.func_0031FCE8")));

extern "C" const type_info &func_0031FCE8 (void) {
  if ((*(void **) D_003C4438) == 0)
    new (D_003C4438) __builtin_type_info (D_00451100);
  return *(type_info *)D_003C4438;
}
