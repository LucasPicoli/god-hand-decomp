...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(Ux) macro (lines 288-300).
...
extern unsigned char D_003C4470[8];          /* __tiUx */
extern const char D_00451138[];              /* "Ux" */

extern "C" const type_info &func_0031FE70 (void)
  __attribute__((section(".text.func_0031FE70")));

extern "C" const type_info &func_0031FE70 (void) {
  if ((*(void **) D_003C4470) == 0)
    new (D_003C4470) __builtin_type_info (D_00451138);
  return *(type_info *)D_003C4470;
}
