...
/* wave 31 L1_libstdcxx: every inline member of istdiostream is DECLARED, not defined, so the TU
...
/* ---- body ---- */
__attribute__((section(".text._$_12istdiostream")))
