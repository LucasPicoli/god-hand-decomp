...
extern struct Table_func_0017C8E0 D_00421D48;

struct Entry_func_0017C8E0 { short f0; unsigned short type; unsigned short f4; short f6; };
struct Table_func_0017C8E0 { struct Entry_func_0017C8E0 e[4]; };

__attribute__((section(".text.func_0017C8E0")))
void func_0017C8E0(void *a0)
{
    char *s0 = (char *)a0;
    struct Table_func_0017C8E0 buf;
    char *e;
    int i8;
    int f0;
