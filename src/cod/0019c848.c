...
extern struct Table_func_0019C848 D_00425C58;

struct Entry_func_0019C848 { short f0; unsigned short type; unsigned short f4; short f6; };
struct Table_func_0019C848 { struct Entry_func_0019C848 e[4]; };

__attribute__((section(".text.func_0019C848")))
void func_0019C848(void *a0)
{
    char *s0 = (char *)a0;
    struct Table_func_0019C848 buf;
    char *e;
    int i8;
    int f0;
