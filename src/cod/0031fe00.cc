...
#pragma interface
/* gcc-2.95.2 gcc/cp/tinfo2.cc, the BUILTIN(Ui) macro (lines 288-300).
...
extern unsigned char D_003C4460[8];          /* __tiUi */
extern const char D_00451128[];              /* "Ui" */

extern "C" const type_info &func_0031FE00 (void)
  __attribute__((section(".text.func_0031FE00")));

extern "C" const type_info &func_0031FE00 (void) {
  if ((*(void **) D_003C4460) == 0)
    new (D_003C4460) __builtin_type_info (D_00451128);
  return *(type_info *)D_003C4460;
}
