...
/* wave 31 L9_clones: istream::~istream() declared in-class and defined below; every other inline
   member of istream is DECLARED, not defined (L1 declare-not-define lever), so the TU emits no
...
/* ---- body ---- */
__attribute__((section(".text._$_7istream")))
istream::~istream() { }
