...
/* ---- body ---- */
extern "C" { _IO_size_t _IO_sgetn __P ((_IO_FILE *, void *, _IO_size_t)); }
/* libioP.h _IO_sputn, written out (libioP.h itself needs errno.h/iolibio.h) */
...
__attribute__((section(".text.__ls__7ostreamP9streambuf")))
