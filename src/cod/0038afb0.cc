...
#endif
    // Retail null-checks the pointer, so the delete EXPRESSION is what the
    // shipped source used, not the naked operator delete[] of gcc-2.95.2.
    delete [] (char *) _arrays;
}
} // extern "C++"
#endif /* _STREAMBUF_H */
...
/* ---- libioP.h (declarations only, transcribed) ---- */
extern "C" {
...
/* libio stdstreams.cc :: ios::sync_with_stdio.
 * The four stream objects and the two buffer sets are retail data; this repo
 * has not named them yet, so they appear here under their D_ addresses. */
extern char D_003F4FD8[], D_003F5038[], D_003F5098[];  /* _IO_stdin_buf, _IO_stdout_buf, _IO_stderr_buf */
extern char D_003F4ED0[], D_003F4F28[], D_003F4F80[];  /* _IO_stdin_, _IO_stdout_, _IO_stderr_ */
extern streambuf *D_003F3DB0;   /* cin.base._strbuf  */
extern streambuf *D_003F3D28;   /* cout.base._strbuf */
extern streambuf *D_003F3D68;   /* cerr.base._strbuf */
extern streambuf *D_003F3DF0;   /* clog.base._strbuf */
extern int D_003F3D18;          /* use_stdiobuf */

__attribute__((section(".text.sync_with_stdio__3iosi")))
int ios::sync_with_stdio(int new_state)
{
    if (new_state == D_003F3D18) // The usual case now.
	return D_003F3D18;
    if (new_state) {
	D_003F3DB0 = (streambuf*)D_003F4FD8;
	D_003F3D28 = (streambuf*)D_003F5038;
	D_003F3D68 = (streambuf*)D_003F5098;
	D_003F3DF0 = (streambuf*)D_003F5098;
    } else {
	D_003F3DB0 = (streambuf*)D_003F4ED0;
	D_003F3D28 = (streambuf*)D_003F4F28;
	D_003F3D68 = (streambuf*)D_003F4F80;
	D_003F3DF0 = (streambuf*)D_003F4F80;
    }
    int old_state = D_003F3D18;
    D_003F3D18 = new_state;
    return old_state;
}
