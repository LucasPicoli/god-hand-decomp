...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        help="Comma-separated rule set for the FP hazard inserter; implies "
             ...
             "under it. 'libm-mtc1' = 'libm' without its "
             "mfc1-after-convert pad. 'cmppad' = INSERT one nop after a "
             "c.<cond>.s whose bc1* follows immediately and whose delay slot "
             "ee-as leaves full. 'fpfence' = fence an FP arithmetic op that "
             "immediately precedes a jump or branch. "
             "Default (the bare flag): mtc1,cvtdiv. Twin of "
