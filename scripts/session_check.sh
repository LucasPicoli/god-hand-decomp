...
DEFAULT_CHECKS=(splat rel-splat metadata build rel expected expected_stale dual_compiler_regress c_flags_necessary units score diff data_decls forced_regs naming_debt naming_sync monolith_sync jtbl_words carve_allowlist compile_units_tracked section_owner registers tu_complete atlas social)
